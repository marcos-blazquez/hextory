...
| [Env + flow variables SDD (0008)](docs/design/0008-env-and-flow-variables.md) | Environment + in-flow vars (`{{var}}` / `VariableResolverPort`) — **Draft**; dual review pending |
