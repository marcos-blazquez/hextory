...
| Bugfixes that stay in scope of an Approved SDD | Studio UI until DES-0003 **Approved**; AWS/observability impl must cite **Approved** DES-0005 / DES-0006 |
...
| [DES-0008](docs/design/0008-env-and-flow-variables.md) | Draft | Env + in-flow vars (`{{var}}` / `VariableResolverPort`) — **no implementation until Approved** |
...
4. Do not merge implementation for Draft-only SDDs (including DES-0003 Studio). AWS / observability / on-prem impl must cite the matching **Approved** SDD (DES-0005 / DES-0006 / DES-0004).
